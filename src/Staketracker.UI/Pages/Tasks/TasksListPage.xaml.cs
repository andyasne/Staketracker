...
using Staketracker.Core.ViewModels.Tasks;
using Telerik.XamarinForms.DataControls;
using Xamarin.Forms;

namespace Staketracker.UI.Pages.Tasks
{
    public partial class TasksListPage : MvxContentPage<TasksListViewModel>, IMvxOverridePresentationAttribute
    {
