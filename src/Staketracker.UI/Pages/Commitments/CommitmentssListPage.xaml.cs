...
using Staketracker.Core.ViewModels.Commitments;
using Telerik.XamarinForms.DataControls;
using Xamarin.Forms;

namespace Staketracker.UI.Pages.Commitments
{
    public partial class CommitmentsListPage : MvxContentPage<CommitmentsViewModel>, IMvxOverridePresentationAttribute
    {
        public CommitmentsListPage()
        {
            InitializeComponent();
